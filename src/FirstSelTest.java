...
public class FirstSelTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.gecko.driver", "E:\\\\Selenium5thBatch\\geckodriver-v0.17.0-win64\\geckodriver.exe");
	...
	//WebDriver driver = new ChromeDriver()
		...
		Select departmonth = new Select(driver.findElement(By.xpath("html/body/div/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[5]/td/form/table/tbody/tr[5]/td[2]/select[1]")));
		departmonth.selectByIndex(7);
		
		Select departday = new Select(driver.findElement(By.xpath("html/body/div/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[5]/td/form/table/tbody/tr[5]/td[2]/select[2]")));
		departday.selectByIndex(9);
		
		Select arivingin = new Select(driver.findElement(By.xpath("html/body/div/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[5]/td/form/table/tbody/tr[6]/td[2]/select")));
		arivingin.selectByIndex(4);
		
		Select returnmonth = new Select(driver.findElement(By.xpath("html/body/div/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[5]/td/form/table/tbody/tr[7]/td[2]/select[1]")));
		returnmonth.selectByIndex(8);
		

		Select returnday = new Select(driver.findElement(By.xpath("html/body/div/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[5]/td/form/table/tbody/tr[7]/td[2]/select[2]")));
		returnday.selectByIndex(23);
